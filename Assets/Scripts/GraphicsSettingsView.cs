...
public class GraphicsSettingsView : MonoBehaviour
{
    ...
    private void AddListeners()
    {
        ...
        previousFullScreenButton.onClick.AddListener(ToggleFullScreenMode);
        nextFullScreenButton.onClick.AddListener(ToggleFullScreenMode);
    ...
    {
        bool currentFullScreenMode = graphicsSettings.CurrentFullScreenMode;
        graphicsSettings.SetFullscreenMode(!currentFullScreenMode);
    }
