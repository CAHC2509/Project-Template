...
public class ButtonSelectedState : ButtonState
{
    public ButtonSelectedState(SelectableData selectableData, Image[] mainImages, Image[] secondaryImages, TextMeshProUGUI[] texts)
    {
