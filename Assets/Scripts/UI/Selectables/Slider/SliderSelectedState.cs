...
public class SliderSelectedState : SliderState
{
    public SliderSelectedState(SelectableData selectableData, Image[] mainImages, Image[] secondaryImages, TextMeshProUGUI[] texts)
    {
