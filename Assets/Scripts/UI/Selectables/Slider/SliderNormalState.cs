...
public class SliderNormalState : SliderState
{
    public SliderNormalState(SelectableData selectableData, Image[] mainImages, Image[] secondaryImages, TextMeshProUGUI[] texts)
    {
