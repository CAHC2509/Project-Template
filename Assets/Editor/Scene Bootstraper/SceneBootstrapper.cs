...
namespace DesignPatterns.Core.Editor
{
    ...
    public class SceneBootstrapper
    {
        ...
        private const string k_LoadBootstrapMenu = "Scene Bootstraper/Load Bootstrap Scene On Play";
        private const string k_DontLoadBootstrapMenu = "Scene Bootstraper/Don't Load Bootstrap Scene On Play";
